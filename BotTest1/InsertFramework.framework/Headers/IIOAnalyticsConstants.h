...
typedef NS_ENUM(NSInteger, IIOAnalyticsVideoStopReason){
    IIOanalyticsVideoStopReasonUserAction,
    IIOAnalyticsVideoStopReasonCloseButton,
    IIOAnalyticsDismissedReasonUnknown
};

typedef NS_ENUM(NSInteger, IIOAnalyticsVideoPauseReason){
    IIOAnalyticsVideoPauseReasonUserAction,
    IIOAnalyticsVideoPauseReasonPlayInBrowser,
    IIOAnalyticsVideoPauseReasonConnectivity,
    IIOAnalyticsVideoPauseReasonVideoComplete
};
...
FOUNDATION_EXTERN NSString * const kDisplayDurationInMillis;
...
FOUNDATION_EXTERN NSString * const kScreenId;
FOUNDATION_EXTERN NSString * const kElementId;
FOUNDATION_EXTERN NSString * const kItemId;
FOUNDATION_EXTERN NSString * const kItemIndex;
FOUNDATION_EXTERN NSString * const kItemText;
...
FOUNDATION_EXPORT NSString *const kTotalPlayDurationMillisKey;
